...
require 'includes/functions.php';                          // 현재경로
...
$sql = "SELECT forename, surname, joined, picture FROM member2 WHERE id = :id;"; // SQL
  ...
  <main class="container" id="content">
    ...
    <?php foreach ($articles as $article) { ?>
      <article class="summary">
        ...
        <p class="credit">
          아티클 :  <a href="category.php?id=<?= $article['category_id'] ?>">
